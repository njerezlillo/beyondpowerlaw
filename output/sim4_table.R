...
load("simulation/results/sim4_size_case1.RData")
...
load("simulation/results/sim4_size_case2.RData")
...
load("simulation/results/sim4_size_case3.RData")
size_c3 <- results 
load("simulation/results/sim4_power_case3.RData")
powr_c3 <- results
...
load("simulation/results/sim4_size_case4.RData")
size_c4 <- results 
load("simulation/results/sim4_power_case4.RData")
powr_c4 <- results
